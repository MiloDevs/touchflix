...
export default function Works() {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-4xl mx-auto"> {/* Added max-width and centered using mx-auto */}
    {Steps.map((step, index) => (
      <div className="max-w-xs p-4 mx-4 my-4 border border-gray-300 bg-white rounded-lg shadow-lg flex flex-col items-center" key={index}>
        <div className="mb-4">
          <Image
            width={64}
            height={64}
